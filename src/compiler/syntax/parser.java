...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Fri Apr 08 22:03:43 CEST 2022
  */
...
class CUP$parser$actions {
  ...
  public final java_cup.runtime.Symbol CUP$parser$do_action(
    ...
    throws java.lang.Exception
    {
      ...
      switch (CUP$parser$act_num)
		...
		Token id = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-3)).value;
		 //TODO la parte de parametrofuncionoproc
	// Comprobamos si el identificador de la funcion esta previametne incluido en la tabla de simbolos
	if(scopeManager.containsSymbol(id.getLexema().toUpperCase())){
		...
		semanticErrorManager.semanticFatalError("La funcion "+ id.getLexema().toUpperCase()+ " no esta contenido en la tabla de simbolos."); 
	}	
	...
	RESULT = new Selectorvalororeferencia(ex.getId(), true);
	//TODO Pendiente de terminar, solo he contemplado la parte de IDEN, faltarian las demas expresiones para las llamadas a funciones.
	// Volver cuando vaya a hacer las llamadas a las funciones.
