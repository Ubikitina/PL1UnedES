...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Fri Apr 22 21:46:51 CEST 2022
  */
...
class CUP$parser$actions {
  ...
  public final java_cup.runtime.Symbol CUP$parser$do_action(
	...
	if(p.isEsNumero()){
		IntermediateCodeBuilder cb = new IntermediateCodeBuilder(scope);
		cb.addQuadruples(p.getIntermediateCode()); //aqui es donde busco el codigo de intermedio de lo de arriba.
		// cb.addQuadruple("ESCRIBENT", p.getTemporal()); //TODO pendiente implementar esto
		s.setIntermediateCode(cb.create());
		System.out.println("Codigo intermedio: " + s.getIntermediateCode());
		RESULT = s;
	}
	...
	if(p.isEsVacio()){
		...
		IntermediateCodeBuilder cb = new IntermediateCodeBuilder(scope);
		TemporalIF temp = tF.create();
		cb.addQuadruple("ESCRIBVAC", temp);
		s.setIntermediateCode(cb.create());
		System.out.println("Codigo intermedio: " + s.getIntermediateCode());
		RESULT = s;
	}
	...
	ParametroEscribir p = new ParametroEscribir(); //AQUI quizás tenga más sentido devolver directamente la expresion, porque necesito enviar tambien el codigo intermedio. Pensar un poco en esto.
	p.setEsNumero(true);
	RESULT = p;
	...
	a.setIntermediateCode(def.getIntermediateCode());
