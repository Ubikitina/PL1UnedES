...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Sun Jun 12 15:51:13 CEST 2022
  */
...
class CUP$parser$actions {
  ...
  public final java_cup.runtime.Symbol CUP$parser$do_action(
	...
	cb.addQuadruple("SUB", desplaz, tempPosicion, rangoInferiorVector); //Correccion para cuando los rangos de los vectores no empiezan en 0
	cb.addQuadruple("SUB", temp2, temp1, desplaz); //Restamos el desplazamiento para acceder a la posicion
	...
	cb.addQuadruple("STPINVERT", temp, tempAnterior);
	expr.setTemporal(temp);
	expr.setIntermediateCode(cb.create());
	...
	cb.addQuadruple("STPINVERT", temp, m.getTemporal());
	vr.setTemporal(temp);
